...
# Gemini API setup
# Get API key from environment variable (REQUIRED - do not hardcode)
GEMINI_API_KEY = os.getenv('GEMINI_API_KEY', '')
if not GEMINI_API_KEY:
    print("[WARNING] GEMINI_API_KEY environment variable not set. Gemini features will not work.")
    print("[INFO] Set it with: export GEMINI_API_KEY=your_key (Linux/Mac) or $env:GEMINI_API_KEY='your_key' (Windows)")
try:
